...
def run_scenario_gateway_multi_worker_case(args) -> int:
    """Run two gateway workers against one pending queue and prove every request completes once."""
...
def run_scenario_real_model_recovery_case(args) -> int:
    """Run a subagent with a real model API, then prove memory-resume recovers real response content."""
