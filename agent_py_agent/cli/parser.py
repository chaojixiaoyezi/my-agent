...
def build_parser() -> argparse.ArgumentParser:
    ...
    task_show = sub.add_parser("task-show", help="显示任务详情")
    ...
    audit = sub.add_parser("audit-log", help="查询审计日志")
