# LLM: File-exists test aliases expand from artifact refs, not model summaries.
# 模块用途: 将 file_exists/path_exists/artifact_exists 别名转成 workspace 内 file_check 项。
