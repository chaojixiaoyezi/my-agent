...
"""Facade for SimpleAgent parent-dispatch and watch-loop orchestration.

The mixin keeps the public method names stable while delegating behavior to
small service modules. Dispatch execution intent should flow through
DispatchExecutionPlan; legacy apply-style names stay at compatibility edges.
"""
...
from .facade import _DispatchFacadeMixin, _DispatchFailureMixin
