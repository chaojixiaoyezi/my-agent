...
def command_for_case(
    ...
    *,
    ...
    delivery_contract_path = case_paths(workspace, case.case_id)["delivery_contract"]
    write_json(delivery_contract_path, delivery_contract_for_case(case, workspace=workspace))
    return [
        sys.executable,
        "-m",
        "agent_py_agent",
...
def delivery_contract_for_case(case: MainAgentRealTaskCasePlan, *, workspace: Path) -> dict[str, object]:
