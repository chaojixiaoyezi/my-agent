...
class TestEntityComparisonFunctions:
    ...
    def test_same_auth_scope_exists(self):
        ...
        from agent_py_agent.agent.log_analysis.analytics.detectors.classifiers import _same_auth_scope
...
class TestAssetFunctions:
    ...
    def test_asset_candidates_exists(self):
        ...
        from agent_py_agent.agent.log_analysis.analytics.detectors.classifiers import _asset_candidates
...
class TestEntityFunctions:
    ...
    def test_entities_from_events_exists(self):
        ...
        from agent_py_agent.agent.log_analysis.analytics.detectors.classifiers import _entities_from_events
        assert callable(_entities_from_events)

    def test_normalize_entities_exists(self):
        """_normalize_entities 函数存在。"""
        from agent_py_agent.agent.log_analysis.analytics.detectors.classifiers import _normalize_entities
    ...
    def test_unique_json_values_exists(self):
        ...
        from agent_py_agent.agent.log_analysis.analytics.detectors.classifiers import _unique_json_values
...
class TestEventClassificationFunctions:
    ...
    def test_is_alert_event_exists(self):
        ...
        from agent_py_agent.agent.log_analysis.analytics.detectors.classifiers import _is_alert_event
    ...
    def test_is_http_success_or_error_exists(self):
        ...
        from agent_py_agent.agent.log_analysis.analytics.detectors.classifiers import _is_http_success_or_error
    ...
    def test_is_suspicious_web_process_event_exists(self):
        ...
        from agent_py_agent.agent.log_analysis.analytics.detectors.classifiers import _is_suspicious_web_process_event
    ...
    def test_is_suspicious_file_write_exists(self):
        ...
        from agent_py_agent.agent.log_analysis.analytics.detectors.classifiers import _is_suspicious_file_write
        assert callable(_is_suspicious_file_write)

    def test_is_egress_event_exists(self):
        """_is_egress_event 函数存在。"""
        from agent_py_agent.agent.log_analysis.analytics.detectors.classifiers import _is_egress_event
