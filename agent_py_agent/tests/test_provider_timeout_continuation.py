...
def test_loop_resumes_and_sends_host_instruction(monkeypatch) -> None:
    ...
    with monkeypatch.context() as loop_patch:
        ...
        loop_result = _tool_loop_service.execute_tool_loop(agent, params)
        _prompt, response, _rounds = loop_result.final_prompt, loop_result.final_response, loop_result.tool_rounds
