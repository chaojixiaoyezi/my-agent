...
# LLM: artifact integrity should catch files that are incomplete before closeout.
...
# LLM: post-write feedback should point models at fake hash links before closeout.
