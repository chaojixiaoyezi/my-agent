...
class TestCmdSubagentsMemoryGate:
    """测试 cmd_subagents_memory_gate 命令。"""

    def test_cmd_subagents_memory_gate_lists_candidates(self, tmp_path: Path, capsys):
    ...
    def test_cmd_subagents_memory_gate_records_review(self, tmp_path: Path, capsys):
