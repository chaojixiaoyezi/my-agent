...
def _controlled_exec_done_result() -> str:
    return (
        ...
        '  "capability_requests": [],\n'
        '  "artifacts": [],\n'
        '  "tests": [{"name": "controlled-exec-smoke", "validation_method": "file_check", "file_path": "WORK_LOG.md", "ok": true, "summary": "refs present"}],\n'
        '  "patches": [],\n'
        '  "lessons": [],\n'
        '  "next_actions": [],\n'
        '  "blocked_reason": "",\n'
    ...
    def generate(self, prompt: str, on_chunk=None) -> ModelResponse:
        ...
        return ModelResponse(
            text=(
                ...
                '  "artifacts": [],\n'
                '  "tests": [\n'
                '    {"name": "repair-format", "validation_method": "file_check", "file_path": "WORK_LOG.md", "ok": true, "summary": "结构化格式已恢复"}\n'
                "  ],\n"
                '  "patches": [],\n'
                '  "lessons": [],\n'
                '  "next_actions": [],\n'
