...
class TestHttpRequestValidation:
    """测试 web_fetch 参数和错误边界。"""

    def test_web_fetch_invalid_method(self, tmp_path: Path):
        """无效 HTTP 方法被拒绝。"""
        from agent_py_agent.agent.tooling.web import WebFetchTool
    ...
    def test_web_fetch_headers_dict(self, tmp_path: Path):
        """字典格式请求头。"""
        from agent_py_agent.agent.tooling.web import WebFetchTool
    ...
    def test_web_fetch_invalid_headers_json(self, tmp_path: Path):
        """无效 JSON 请求头被拒绝。"""
        from agent_py_agent.agent.tooling.web import WebFetchTool
    ...
    def test_web_fetch_headers_too_many(self, tmp_path: Path):
        """请求头过多被拒绝。"""
        from agent_py_agent.agent.tooling.web import WebFetchTool
