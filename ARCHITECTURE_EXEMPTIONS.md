...
| E-006 | `agent/subagents/manager_base.py` | 751 lines | Base manager state machine has 8 states and 12 transitions. Extraction requires state machine test coverage. State file format is a compatibility constraint. | State file format change; CLI behavior change | Extract `lifecycle_service.py`, `state_machine.py`; target < 200 lines facade | architecture owner | 2026-07-15 |
| E-007 | `agent/log_analysis/analytics/detectors/rules.py` | 745 lines | Routing rules are data-driven but rule loading has caching implications. Low risk but needs loader test suite. | Routing behavior change | Extract `rule_models.py`, `rule_evaluator.py`, `rule_loader.py`; target < 200 lines | architecture owner | 2026-07-15 |
...
| E-009 | `cli/memory_commands.py` | 608 lines | Memory CLI commands are growing. Low risk to split but not yet at hard limit. | None significant | Split into `memory_query_cmd.py`, `memory_archive_cmd.py`, `memory_doctor_cmd.py` | architecture owner | 2026-06-30 |
