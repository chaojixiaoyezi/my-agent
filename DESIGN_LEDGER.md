...
**可选决策模型：P1—P5 完整实施已授权，P1 与 Curator 已本地验收，子代理/召回已本地验收，原设置入口、原生测试与 agent 代操作已本地联合验收，10 能力减量实施中。**
...
下一片已确认采用工作片展示投影减少Skill名卡/工具目录及明确可选类别schema；原权限/快照身份保持，被收起项由原搜索找回。
