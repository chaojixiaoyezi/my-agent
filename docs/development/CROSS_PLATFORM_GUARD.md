...
python -m pytest agent_py_agent/tests/test_process_control.py agent_py_agent/tests/test_daemon_control.py agent_py_agent/tests/test_supervisor.py agent_py_agent/tests/test_watchdog.py agent_py_agent/tests/test_dispatch_loop.py agent_py_agent/tests/test_policy_checks.py agent_py_agent/tests/test_subagent_policies.py agent_py_agent/tests/test_manager_patch.py agent_py_agent/tests/test_agent/test_subagent_patch_review.py -q
