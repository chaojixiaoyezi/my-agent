...
> 状态更新（2026-09-23）：本交接的三元 `tooling/call_ref.py` 方案已在决策分支合并版被 v3 四元身份取代，本文保留作历史记录。现行设计见[依赖拆分合并节](../design/TOOL_LOOP_DEPENDENCY_SPLIT.md#两线合并后的来源身份与模型轮结果决策分支吸收-main2026-09-23)。
