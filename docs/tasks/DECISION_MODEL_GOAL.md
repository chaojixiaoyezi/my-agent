...
| 12 / P3-E、P4-D/F | 🔄 进行中 | 窗口、缓存与并发故障验收 | Jev两层容量门与目录代次已本地通过；原生计量/主子采用153项、三宿主展示接续及相关回归236项通过；同轮不重决策、新轮重置、后台真实身份已验；12.1/2/3/5/6/7已验；12.4 的 2a、2b、媒体集成与 .9 真实验收已完成，媒体越压缩点缺陷已修并真实验收（待审）；剩媒体屏障（待用户决策）与 Gateway 消息文件整块读取（方案待同意） |
