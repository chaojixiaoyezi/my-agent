...
- 按 `06-runtime-memory-requirements.md` 继续做文件系统版 Phase 1-6：agent run workspace、事件账本、artifact 外置、compact/checkpoint 链、shared 协作面和 memory gate / skill spark 提升链。
