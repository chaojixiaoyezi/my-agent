...
- `agent_py_agent/agent/subagents/services/hierarchy_qa_scheduler.py`：调度阶段的 QA 补派 helper；根据 `qa_role_contract.py` 计算缺失 QA 角色，返回 scheduler-neutral child spec，避免核心 scheduler 继续变胖。
