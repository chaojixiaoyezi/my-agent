...
| `memory_archive/` | `owner_home/memory/`, `owner_home/memory_archive/`；子代理 run 内工具归档写自己的 `work/agents/<run_id>/memory_archive/`，durable Compact 只写 owner canonical ConversationThread/checkpoint | 任何其他路径 |
